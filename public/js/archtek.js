...
jQuery(document).ready(function($) {
    ...
    var showScrollToTopButton = true;
    ...
    $('#header-search-button').click(function() {
        if(!isSearchDisplayed) {
            ...
            $('#header-lang').hide();
            $('#header-lang').addClass('no-showme');
            ...
            if($('#header-lang').hasClass('no-showme'))
            {
                    $('#header-lang').show();
                    $('#header-lang').removeClass('no-showme');
            }
    ...
    if($('.image-slider').length > 0) {
       ...
       * 
       * @toFix
       * optymalizacja kodu initContactForm() 
       * 
       */
    ...
    function initContactForm() {
        ...
        $('#success, #error').css('display', 'none');
            ...
            if($('form#contact-form').hasClass("care-form")) {
                      var customURL = './../admin/addCare';
            }
            else if($('form#contact-form').hasClass("client-form")) {
                      var customURL = './../admin/addClient';                     
            }
            else if($('form#contact-form').hasClass("notification-form")) {
                      var customURL = './../admin/addNotification';                     
            }
            else if($('form#contact-form').hasClass("personel-form")) {
                      var customURL = './../admin/addPersonel';                     
            }
            else if($('form#contact-form').hasClass("candidates-form")) {
                      var customURL = './admin/addCandidates';                     
            }
            else {
                      var customURL = './admin/add';
            }
        ...
        if ($('form#contact-form').length > 0) {
            ...
            contactForm.submit(function() {
                ...
                if (contactForm.validationEngine('validate')) {
                    ...
                    $submitButton.attr('value', 'Wysyłanie...');
                    $submitButton.attr('disabled', 'disabled');
                    
                    if($('form#contact-form').hasClass("personel-form") || $('form#contact-form').hasClass("candidates-form") || $('form#contact-form').hasClass("client-form")) {
    ...
    function initMobileMenu() {
        var defaultMenuList = $('#root-menu ul');
        var mobileMenuList = $('<ul />').appendTo($('#mobile-menu .top-bar-section'));
        
        var clonedList = $('#root-menu ul > li').clone();
    ...
    function getGeneratedSubmenu(list) {
     ...
     $(document).scroll(function () {
        ...
        if (y > 450) {
            if($('#superOffer').hasClass('no-touch')) {
...
//     $( ".header-choose-lang" ).click(function() {
//       $( "#dialogLanguage" ).dialog( "open" );
//     });
//     $( "#openLanguageClose" ).click(function() {
...
//     });
     ...
     $( "#openContactClose" ).click(function() {
     ...
     $( "#openFriendClose" ).click(function() {
       $( "#dialogFriend" ).dialog( "close" );
     });
     
     $( "#my-closebutton" ).click(function() {
     
        $("#superOffer").fadeOut().addClass('no-touch');
        $(".superofferIcon").fadeIn();
        
     });
     $( ".superofferIcon" ).click(function() {
     
        $("#superOffer").fadeIn().removeClass('no-touch');
        $(".superofferIcon").fadeOut();
		...
		$('[name=careChange]').bind('change', function (e) {
			if( $(this).val() === 'yes') {
				
				$("#showNumberPerson").slideDown();		
			}
			else{
				$('#showNumberPerson').slideUp();
			}
...
//        });
    ...
    //pokazywanie i ukrywanie facebooka
    $('#show-facebook-action').click(function(e) {
         var facebook = $('.fb-like-box');
         
        if(facebook.is(':visible')) {
             $('.facebook-div').hide('slide', {direction: 'right'}, 500);
             $(facebook).hide().delay(500).delay(500);
             $('.facebook-div').show('slide', {direction: 'right'}, 500);
...
//        
//        
//    //zakaz kopiowania tekstu thanks to BoogieJack.com
//    function killCopy(e){
//        return false;
//    }
//    function reEnable(){
